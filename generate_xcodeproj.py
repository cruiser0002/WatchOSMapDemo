...
def create_pbxproj():
    ...
    # Collect all swift files in RadarMap relative to RadarMap/
    swift_files = []
    ...
    info_plist_id = "FF0000010000000000000001"
    file_refs.append(f'\t\t{info_plist_id} /* Info.plist */ = {{isa = PBXFileReference; lastKnownFileType = text.plist.xml; path = "Resources/Info.plist"; sourceTree = "<group>"; }};')
    ...
    group_children = [f'\t\t\t\t{file_ids[fname]} /* {fname} */,' for fname, _ in swift_files]
    group_children.append(f'\t\t\t\t{info_plist_id} /* Info.plist */,')
    group_children.append(f'\t\t\t\t{google_plist_id} /* GoogleService-Info.plist */,')
    
    sources_build_phase = [f'\t\t\t\t{build_ids[fname]} /* {fname} in Sources */,' for fname, _ in swift_files]
...
\t\t1A0000010000000000000001 /* RadarMap.app */ = {{isa = PBXFileReference; explicitFileType = wrapper.application; includeInIndex = 0; path = "RadarMap.app"; sourceTree = BUILT_PRODUCTS_DIR; }};
...
\t\t\tisa = PBXGroup;
\t\t\tchildren = (
\t\t\t\t1A0000010000000000000001 /* RadarMap.app */,
\t\t\t);
\t\t\tname = Products;
\t\t\tsourceTree = "<group>";
\t\t}};
...
\t\t1A0000060000000000000001 /* RadarMap */ = {{
\t\t\tisa = PBXNativeTarget;
\t\t\tbuildConfigurationList = 1A0000070000000000000001 /* Build configuration list for PBXNativeTarget "RadarMap" */;
\t\t\tbuildPhases = (
...
\t\t\tproductReference = 1A0000010000000000000001 /* RadarMap.app */;
...
\t\t\tbuildActionMask = 2147483647;
\t\t\tfiles = (
{chr(10).join(sources_build_phase)}
\t\t\t);
\t\t\trunOnlyForDeploymentPostprocessing = 0;
\t\t}};
...
\t\t}};
\t\t1A0000070000000000000001 /* Build configuration list for PBXNativeTarget "RadarMap" */ = {{
\t\t\tisa = XCConfigurationList;
\t\t\tbuildConfigurations = (
\t\t\t\t1A00000D0000000000000001 /* Debug */,
\t\t\t\t1A00000E0000000000000001 /* Release */,
...
"""
    ...
    print(f"Generated standalone watchOS Xcode project: {pbxproj_path}")
